...
public class Drivetrain extends SubsystemBase {
  ...
  public boolean theotherlimitswitch;
  ...
  public void periodic() {
    ...
    isLimitSwitchClosed = (LeftBackMotor.isFwdLimitSwitchClosed() == 1);
    theotherlimitswitch = (LeftBackMotor.isRevLimitSwitchClosed() == 1);

    
    SmartDashboard.putBoolean("Limit Switch", isLimitSwitchClosed);
    SmartDashboard.putBoolean("Oter Limit Switch", theotherlimitswitch);
  }
